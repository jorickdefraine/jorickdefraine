...
### [UMYO](https://umyo-app.vercel.app) — USDC Yield Optimizer on Morpho/Base
...
- **Live on Base mainnet** · [dApp](https://umyo-app.vercel.app) · [Contract on Basescan](https://basescan.org/address/0xa41af22a823d8756911e58e0603763d934ac4038) <!-- replace # with your verified contract address -->
- Stack: Solidity · Foundry · OpenZeppelin · Morpho · Base

---

## Open source contributions

- **[DeFiLlama](https://github.com/DefiLlama)** — protocol adapters and TVL integrations · [2 merged PRs](https://github.com/DefiLlama) · 1 open
